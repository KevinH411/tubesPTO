...
public class PelicanExploration {
    ...
    // dengan posisi mangsa
    // lalu menyimpan hasilnya ke dalam vektor Solution.arr milik kandidat.
    ...
    public void hitung(Pelican kandidat, Pelican saatIni, Pelican mangsa, Random rand) {
        ...
        int I = rand.nextInt(2) + 1; // bernilai 1 atau 2, sesuai rumus POA, 2 = berpindah lebih jauh (eksplorasi)
                                     // dan 1 = menetap.
